...
var forms = function forms(state) {
  var formsEl = document.querySelectorAll("form"),
  ...
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    trigger.forEach(function (item) {
      item.addEventListener("click", function (e) {
        ...
        document.body.style.overflow = "hidden"; // document.body.classList.add("modal-open")   ------ Вариант с использованием класса из бутстрапа
      });
    });
    close.addEventListener("click", function () {
      ...
      document.body.style.overflow = ""; // document.body.classList.remove("modal-open")  ------ Вариант с использованием класса из бутстрапа
    });
